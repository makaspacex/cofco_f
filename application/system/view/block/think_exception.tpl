...
<head>
    <meta charset="UTF-8">
    <title><?php  if (\think\facade\App::isDebug()) { echo '系统发生错误'; } else { echo '404'; }  ?></title>
...
<body style="background-color:#f2f2f2">
    ...
    <div style="margin-top:200px;width:100%;text-align:center;">
        ...
        <p><a href="javascript:history.back(-1);"><返回上一页</a><a href="/">去首页></a></p>
    </div>
<?php } else { ?>
<body>
    <div class="echo">
    ...
    <div class="copyright">
        ...
        <span>V<?php echo \think\facade\Config::get('hisiphp.version'); ?></span> 
