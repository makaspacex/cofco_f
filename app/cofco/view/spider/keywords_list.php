<form class="page-list-form">
    <div class="layui-btn-group">
        ...
        <a data-href="{:url('status?table=spider_keywords&val=1')}" class="layui-btn layui-btn-primary j-page-btns"><i class="aicon ai-qiyong"></i>启用</a>
        <a data-href="{:url('status?table=spider_keywords&val=0')}" class="layui-btn layui-btn-primary j-page-btns"><i class="aicon ai-jinyong1"></i>禁用</a>
