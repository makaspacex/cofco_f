<form class="page-list-form">
    <div class="page-toolbar">
        ...
        <div class="layui-btn-group">
            <a href="{:url('pending_add')}" class="layui-btn layui-btn-primary j-ajax"><i class="aicon ai-tianjia"></i>添加</a>
        ...
        <table class="layui-table mt10" lay-even="" lay-skin="row">
            ...
            <tr>
                ...
                <td>
                    <div class="layui-btn-group">
                        <div class="layui-btn-group">
                            <a href="{:url('pending_edit?id='.$v['id'])}"class="layui-btn layui-btn-primary layui-btn-sm j-ajax"><i class="layui-icon">&#xe642;</i></a>
