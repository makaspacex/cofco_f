...
<form class="page-list-form">
    <div class="page-toolbar">
        <div class="layui-btn-group fl">
            ...
            <a data-href="{:url('levellabel_del')}" class="layui-btn layui-btn-primary j-page-btns confirm"><i class="aicon ai-jinyong"></i>删除</a>
        </div>
    </div>
    ...
    <dl class="menu-dl1">
        ...
        <dd>
            ...
            <dl class="menu-dl2">
                <dt>
                    <input type="checkbox" name="{$vvv['id']}"  value="{$vvv['cid']}" class="checkbox-ids" lay-skin="primary" title="{$vvv['value']}"><div class="layui-unselect layui-form-checkbox" lay-skin="primary"><span>{$vvv['value']}</span><i class="layui-icon">&#xe626;</i></div>
                ...
                {/php}
                <dd>
                    <input type="checkbox" name="{$vvvv['id']}"   value="{$vvvv['cid']}" class="checkbox-ids" lay-skin="primary" title="{$vvvv['value']}"><div class="layui-unselect layui-form-checkbox" lay-skin="primary"><span>{$vvvv['value']}</span><i class="layui-icon">&#xe626;</i></div>
