    ...
    <dl class="menu-dl1">
        ...
        <dd>
            ...
            <dl class="menu-dl2">
                ...
                {/php}
                <dd>
                    <input type="checkbox" name="ids[{$kk}]" value="{$vvvv['id']}" class="checkbox-ids" lay-skin="primary" title="{$vvvv['value']}"><div class="layui-unselect layui-form-checkbox" lay-skin="primary"><span>{$vvvv['value']}</span><i class="layui-icon">&#xe626;</i></div>
