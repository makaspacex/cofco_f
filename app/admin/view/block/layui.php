{if condition="defined('MODULENAME') && MODULENAME eq 'COFCO' "}
    ...
    {/if}
<script src="__ADMIN_JS__/layui-v2.4.5/layui.js?v={:config('hisiphp.version')}"></script>
<script src="__ADMIN_JS__/jquery.2.1.4.min.js?v={:config('hisiphp.version')}"></script>
<script>
