<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:104:"/Users/izhangxm/Documents/WORKSTATION/WorkSpaces/PhpStorm/hisiphp-master/app/admin/view/module/index.php";i:1521988218;s:98:"/Users/izhangxm/Documents/WORKSTATION/WorkSpaces/PhpStorm/hisiphp-master/app/admin/view/layout.php";i:1521988218;s:104:"/Users/izhangxm/Documents/WORKSTATION/WorkSpaces/PhpStorm/hisiphp-master/app/admin/view/block/header.php";i:1521988218;s:103:"/Users/izhangxm/Documents/WORKSTATION/WorkSpaces/PhpStorm/hisiphp-master/app/admin/view/block/layui.php";i:1521988218;s:104:"/Users/izhangxm/Documents/WORKSTATION/WorkSpaces/PhpStorm/hisiphp-master/app/admin/view/block/footer.php";i:1521988218;}*/ ?>
...
<?php endif; switch($tab_type): case "1": ?>
    ...
    <table class="layui-table mt10" lay-even="" lay-skin="row">
        ...
        <tbody>
            <?php if(is_array($data_list) || $data_list instanceof \think\Collection || $data_list instanceof \think\Paginator): $i = 0; $__LIST__ = $data_list;if( count($__LIST__)==0 ) : echo "<tr><td colspan='5' align='center' height='100'>未发现相关模块，快去<a href='http://store.hisiphp.com/modules' target='_blank'> <strong style='color:#428bca'>应用市场</strong> </a>看看吧！</td></tr>" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            <tr>
                <td>
                ...
                <td>
                   <input type="checkbox" name="status" <?php if($vo['default'] == 1): ?>checked=""<?php endif; ?> value="<?php echo $vo['default']; ?>" lay-skin="switch" lay-filter="switchStatus" lay-text="是|否" data-href="<?php echo url('setDefault?id='.$vo['id']); ?>">
                </td>
                <td>
                    ...
                    <?php if($vo['system'] != 1): ?>
                        <div class="layui-btn-group">
                            <?php switch($vo['status']): case "0": ?>
                                ...
                                <?php break; case "1": if(config('develop.app_debug') && $vo['app_id'] == 0): ?>
                                        <a href="<?php echo url('edit?id='.$vo['id']); ?>" class="layui-btn layui-btn-primary layui-btn-sm red">编辑</a>
                                    <?php endif; if(!empty($vo['config'])): ?>
                                    <a href="<?php echo url('system/index?group='.$vo['name']); ?>" class="layui-btn layui-btn-primary layui-btn-sm">配置</a>
                                    <?php endif; if($vo['app_id'] > 0): ?>
                                    <a href="<?php echo url('upgrade/lists?app_type=module&app_id='.$vo['app_id']); ?>" class="layui-btn layui-btn-primary layui-btn-sm">更新</a>
                                    <?php else: endif; ?>
                                    <a href="<?php echo url('uninstall?id='.$vo['id']); ?>" class="layui-btn layui-btn-primary layui-btn-sm">卸载</a>
                                <?php break; case "2": if(config('develop.app_debug') && $vo['app_id'] == 0): ?>
                                        <a href="<?php echo url('edit?id='.$vo['id']); ?>" class="layui-btn layui-btn-primary layui-btn-sm red">编辑</a>
                                    <?php endif; if(!empty($vo['config'])): ?>
                                    <a href="<?php echo url('system/index?group='.$vo['name']); ?>" class="layui-btn layui-btn-primary layui-btn-sm">配置</a>
                                    <?php endif; ?>
            ...
            <?php endforeach; endif; else: echo "<tr><td colspan='5' align='center' height='100'>未发现相关模块，快去<a href='http://store.hisiphp.com/modules' target='_blank'> <strong style='color:#428bca'>应用市场</strong> </a>看看吧！</td></tr>" ;endif; ?>
        </tbody>
    </table>
</div>
