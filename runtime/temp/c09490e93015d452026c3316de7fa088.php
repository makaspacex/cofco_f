<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:103:"/Users/izhangxm/Documents/WORKSTATION/WorkSpaces/PhpStorm/hisiphp-master/app/admin/view/config/form.php";i:1522336067;s:98:"/Users/izhangxm/Documents/WORKSTATION/WorkSpaces/PhpStorm/hisiphp-master/app/admin/view/layout.php";i:1521988218;s:104:"/Users/izhangxm/Documents/WORKSTATION/WorkSpaces/PhpStorm/hisiphp-master/app/admin/view/block/header.php";i:1521988218;s:103:"/Users/izhangxm/Documents/WORKSTATION/WorkSpaces/PhpStorm/hisiphp-master/app/admin/view/block/layui.php";i:1521988218;s:104:"/Users/izhangxm/Documents/WORKSTATION/WorkSpaces/PhpStorm/hisiphp-master/app/admin/view/block/footer.php";i:1521988218;}*/ ?>
...
<?php endif; switch($tab_type): case "1": ?>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline w300">
            <select name="group" class="field-group" type="select" lay-filter="group">
                <?php $_result=config('sys.config_group');if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                    <option value="<?php echo $key; ?>"<?php if($key == input('param.group')): ?>selected<?php endif; ?>>[<?php echo $key; ?>]<?php echo $v; ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-form-mid layui-word-aux">由英文字母和下划线组成，必须以字母开头，如：web_name，调用方法：<span class="red">config('<span id="groupShow"><?php if(isset($data_info['group'])): ?><?php echo $data_info['group']; else: ?><?php echo input('param.group'); endif; ?></span>.web_name')</span></div>
    </div>
    <div class="layui-form-item">
