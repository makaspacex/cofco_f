<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:104:"/Users/izhangxm/Documents/WORKSTATION/WorkSpaces/PhpStorm/hisiphp-master/app/admin/view/system/index.php";i:1522334929;s:98:"/Users/izhangxm/Documents/WORKSTATION/WorkSpaces/PhpStorm/hisiphp-master/app/admin/view/layout.php";i:1521988218;s:104:"/Users/izhangxm/Documents/WORKSTATION/WorkSpaces/PhpStorm/hisiphp-master/app/admin/view/block/header.php";i:1521988218;s:103:"/Users/izhangxm/Documents/WORKSTATION/WorkSpaces/PhpStorm/hisiphp-master/app/admin/view/block/layui.php";i:1521988218;s:104:"/Users/izhangxm/Documents/WORKSTATION/WorkSpaces/PhpStorm/hisiphp-master/app/admin/view/block/footer.php";i:1521988218;}*/ ?>
...
<form action="<?php echo url('?group='.input('param.group', 'base')); ?>" class="page-list-form layui-form layui-form-pane" method="post">
    <?php if(is_array($data_list) || $data_list instanceof \think\Collection || $data_list instanceof \think\Paginator): $i = 0; $__LIST__ = $data_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;switch($v['type']): case "multi_textarea": ?>
        <!--富文本-->
        <div class="layui-form-item">
            <label class="layui-form-label"><?php echo $v['title']; ?></label>
            <div class="layui-input-inline">
                <textarea rows="<?php echo config('sys.multi_textarea_num'); ?>"  id="id_<?php echo $v['id']; ?>" name="id[<?php echo $v['id']; ?>]"><?php echo htmlspecialchars_decode($v['value']); ?></textarea>
                <br>
